...
%% Add your info here:
\offprintinfo{Problem-Model-Algorithm-Code, first edition}{Zhonghua Li}
...
Problem-Model-Algorithm-Code / Zhonghua Li
\end{copyrightpage}
...
\include{body/nlp/word-representation-problem}


\include{body/nlp/latent-sematic-analysis}


\include{body/nlp/probabilistic-latent-semantic-analysis}


\include{body/nlp/latent-dirichlet-allocation}


\include{body/nlp/word2vec}

\include{body/nlp/brown-clustering}
